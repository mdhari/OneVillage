...
import edu.sjsu.carbonated.mongodbaccessors.MongoDBBlog;
...
@Path("/blog")
public class Blog {
	MongoDBBlog mDBBlog = new MongoDBBlog();
	// XXX: TO REMOVE
	...
	public BlogResource createBlog(BlogResource request){
		//return "test";
		mDBBlog.addEntry(request);
