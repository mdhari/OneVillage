...
import edu.sjsu.carbonated.data.GroupResource;
...
@Path("/group")
public class Group {
	MongoDBGroup mDBGroup = new MongoDBGroup();
	...
	public GroupResource addGroup(GroupResource request) {
		// return "test";
		mDBGroup.addEntry(request);
